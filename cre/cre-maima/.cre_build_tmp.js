...
function onCronTrigger(runtime2) {
  runtime2.log("MAIMA orchestrator triggered.");
  const out = runtime2.runInNodeMode(orchestrate, consensusIdenticalAggregation())().result();
  runtime2.log("[1] Queue polled.");
  runtime2.log("[2] Delegated " + out.delegatedCount + " request(s) to cre-swap / cre-bridge.");
  return out;
}
async function main() {
