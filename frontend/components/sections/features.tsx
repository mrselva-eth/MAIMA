...
const FEATURES = [
  ...
  { image: '/images/features/f2.png', title: 'Multi-Protocol Aggregation', desc: 'MAIMA uses LI.FI to aggregate routes from Uniswap, 1inch, KyberSwap, Paraswap, and more. One request, many protocols compared.' },
