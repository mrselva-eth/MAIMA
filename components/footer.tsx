          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 mb-12 lg:mb-14">
            ...
            <div className="lg:col-span-6 space-y-5">
              ...
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed max-w-md">
                Intent-based smart wallet. Express your goals, not your transactions.
              </p>
          </div>
          ...
          {/* Product */}
            <div className="lg:col-span-2 space-y-4">
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                <li>
                  <Link href="/dashboard" className="hover:text-[#60a5fa] transition-colors inline-block">
                  Dashboard
                </Link>
              </li>
              <li>
                  <Link href="/intents" className="hover:text-[#60a5fa] transition-colors inline-block">
                  Intents
                </Link>
              </li>
              <li>
